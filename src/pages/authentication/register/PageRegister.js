			...
			<>
				...
				<Form.Group className="mb-3">
					...
					<Form.Text className="text-muted">
						...
						>
							{isPasswordVisible ? t('authentication_register_password_hide') : t('authentication_register_password_show')}
						</Button>
					</Form.Text>
					<Form.Control.Feedback type="invalid">
				...
				<Form.Group className="mb-3">
					...
					<Form.Text className="text-muted">
						...
						>
							{isPasswordConfirmVisible ? t('authentication_register_passwordConfirm_hide') : t('authentication_register_passwordConfirm_show')}
						</Button>
					</Form.Text>
					<Form.Control.Feedback type="invalid">
						{t(passwordConfirm.errorMessage)}
					</Form.Control.Feedback>
				</Form.Group>
