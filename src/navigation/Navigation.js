...
export class Navigation {
	static menus = [
		new Menu(
			...
			'bi bi-calendar',
			[
				new SubMenu(roleCategories.ADMIN, 'calendar', 'common_nav_side_calendar', 'PageOne'),
				new SubMenu(roleCategories.EMPLOYEE, 'calendar', 'common_nav_side_calendar', 'PageOne'),
				new SubMenu(roleCategories.CLIENT, 'calendar', 'common_nav_side_calendar', 'PageOne')
			]
		),
		new Menu(
			'community',
